...
//             if (response.ok) {
//                 const data = await response.json();
//                 const userResponse = await fetch('http://127.0.0.1:8000/get_user/' + email);
//                 const userData = await userResponse.json();

//                 sessionStorage.setItem('user', JSON.stringify(userData));
//                 sessionStorage.setItem('isAdmin', userData.is_admin);

//                 window.location.href = userData.is_admin ? 'http://127.0.0.1:5500/dashboard.html' : 'http://127.0.0.1:5500/manager_dashboard.html';
//             } else {
